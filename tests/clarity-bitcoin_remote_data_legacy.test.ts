...
import { verifyMerkleProof, wasTxMinedCompact } from './clients/clarity-bitcoin-client.ts';
...
const merkleRoot = 'c3ea93871597bb4d026d52c450971cf70ac0bf8fa435ea1ad1049b32977b1669';

const wMerkleRoot = 'd46461bd8a483c8ad0acaa9d72e54b2c04bfa7c19dc37a7b0805c2f959e832cd';
...
describe('Bitcoin library with remote data', () => {
  ...
  it('Ensure that mined legacy tx can be verified ', () => {
    ...
    const result = wasTxMinedCompact(bitcoinHeight, txHex, headerHex, proof, deployer);
