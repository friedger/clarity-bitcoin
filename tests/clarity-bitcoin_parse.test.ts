  ...
  it('Ensure that bitcoin headers can be parsed'),
    () => {
      ...
      expectHeaderObject(response.result, {
        version: 536870912,
        parent: '000000000000000000329dacc896d90782e579acaf142b1c086609482472433c',
        merkleRoot: '4442b5eddeac5cf82585e1175013144f4138c02d7ca06c41f0ecc8772c4c7a84',
      ...
      expectHeaderObject(response.result, {
        version: 747970560,
        parent: '000000000000003ae5e531b437f41753f4730e5b8326ffba3adf6914de169392',
        merkleRoot: '9224732eff9e1f13756a643e5d7a142ae04e50f153cd548ee0805543dadb105c',
