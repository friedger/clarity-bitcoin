...
(define-public (add-burnchain-block-header-hash
  ...
  (contract-call? .clarity-bitcoin mock-add-burnchain-block-header-hash
    burn-height
    (contract-call? .clarity-bitcoin reverse-buff32 (sha256 (sha256 header)))
  )
)
...
(define-public (prepare)
  (begin
    ;; 1
    (unwrap-panic (add-burnchain-block-header-hash u2431087
    ...
    ;; 2
    (unwrap-panic (add-burnchain-block-header-hash u2431459
      0x000000207277c3a739ad34a3873a3c9d755f0766e918f4b37adcfe455d079b93000000000bad83579d633d37aa1e2bb725b8a5bad35509374454f1adad8a4de140066d74dbf64e64ffff001d6616bfe2
    ))
    ;; 3
    (unwrap-panic (add-burnchain-block-header-hash u2431567
      0x000000208af1a70ab2ed062c7ac53eb56b053498db50f0d9c41f0dc8a5efcb1b000000007b64b9e16eb97b1fb32977aa00e2cb7418856b1e794e232be4f3b4b0512cb31256845064ffff001dc3cdbab0
    ))
    ;; 4
    (unwrap-panic (add-burnchain-block-header-hash u2431619
      0x00c0c8306c887f5b2248021d1a6662aa684ca46975a21685800192b3f4e5c8b400000000a140532ff49146607e72df19983ff1e4a56f989cf0671aeb4ee321a74d3670c75c545164695a20192b1ab0c7
    ))
    ;; 5
    (unwrap-panic (add-burnchain-block-header-hash u2430921
      0x00004020070e3e8245969a60d47d780670d9e05dbbd860927341dda51d000000000000007ecc2f605412dddfe6e5c7798ec114004e6eda96f7045baf653c26ded334cfe27766466488a127199541c0a6
    ))
    ;; 6
    (unwrap-panic (add-burnchain-block-header-hash u2431087
      0x0000a02065bc9201b5b5a1d695a18e4d5efe5d52d8ccc4129a2499141d000000000000009160ba7ae5f29f9632dc0cd89f466ee64e2dddfde737a40808ddc147cd82406f18b8486488a127199842cec7
  ...
  (let (
    ...
    (let ((result (contract-call? .clarity-bitcoin was-tx-mined-compact
        ...
        hashes: (list
          ...
          0x6fed856ef1075c15a1318eeb512349ceb6a5115953990369c9cb03d65a550468
  ...
  (let (
    ...
    (let ((result (contract-call? .clarity-bitcoin was-tx-mined-compact
        ...
        hashes: (list
          ...
          0x1172bf0943aad7bc580aaab5f5d356b1c172f11c297ccf0077515309906352f2
